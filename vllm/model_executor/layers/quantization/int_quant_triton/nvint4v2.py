...
def nvint4v2_forward_kernel(
    ...
    scales_fp8 = scales.to(tl.float8e4nv) / global_scale

    x_tr_scaled = x_tr_abs / scales_fp8
...
def nvint4v2_forward_kernel_wrapper(
    x: torch.Tensor,
